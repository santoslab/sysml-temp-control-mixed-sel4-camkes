...
//   IS[Z,art.UPort]=3 - Needed for tct's dataIns ports
//   MS[Z,art.UPort]=3 - Needed for the ops.ISZOps(sorted).tail call used by ArtNativeSlang
//   IS[Z,(Z,art.ArtSlangMessage)]=13 - Needed for the backing store of Map[Z, ArgSlangMessage] in ArtNativeSlang
  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--name", "main",
        "--apps", "tc.TempSensor_tsp_tst_App,tc.TempControl_tcp_tct_App,tc.Fan_fp_ft_App,tc.LegacyDemo",
        "--fingerprint", "3",
        "--bits", "64",
        "--string-size", "256",
        "--sequence-size", "100",
        "--sequence", s"MS[Z,Option[art.Bridge]]=3;IS[Z,String]=3;IS[Z,art.Art.PortId]=3;IS[Z,art.UPort]=3",
        "--constants", s"art.Art.numComponents=3;art.Art.numPorts=13;art.Art.numConnections=4",
        "--forward", "art.ArtNative=tc.ArtNix,tc.PlatformComm=tc.PlatformCommNix",
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "100",
        "--sequence", s"MS[Z,Option[art.Bridge]]=3;IS[Z,String]=3;IS[Z,art.Art.PortId]=3;IS[Z,art.UPort]=3;MS[Z,art.UPort]=3;IS[Z,(Z,art.ArtSlangMessage)]=13;IS[Z,art.Art.BridgeId]=3;IS[Z,art.scheduling.static.Schedule.Slot]=3;IS[Z,(String,art.Art.BridgeId)]=3",
        "--constants", s"art.Art.numComponents=3;art.Art.numPorts=13;art.Art.numConnections=4",
