...
@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container => B) {}
...
@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container => B) {}
...
@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS => B) {}
...
@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container => B) {}
...
@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.Type], filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P => B) {}

@datatype class Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(attempts: Z, verbose: B, filter: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS => B) {}
