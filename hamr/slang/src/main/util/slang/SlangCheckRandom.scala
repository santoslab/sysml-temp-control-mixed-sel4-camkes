...
@msig trait RandomLibI {
  ...
  def nextIsolette_Data_ModelMonitor_ModeType(): Isolette_Data_Model.Monitor_Mode.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.Isolette_Data_Model.Monitor_Mode.numOfElements-1)

    var v: Isolette_Data_Model.Monitor_Mode.Type = slang.Isolette_Data_Model.Monitor_Mode.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelMonitor_ModeType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelMonitor_ModeType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.Isolette_Data_Model.Monitor_Mode.numOfElements-1)
       v = slang.Isolette_Data_Model.Monitor_Mode.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelMonitor_ModeType.filter(v)) {
  ...
  def nextIsolette_Data_ModelOn_OffType(): Isolette_Data_Model.On_Off.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.Isolette_Data_Model.On_Off.numOfElements-1)

    var v: Isolette_Data_Model.On_Off.Type = slang.Isolette_Data_Model.On_Off.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelOn_OffType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelOn_OffType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.Isolette_Data_Model.On_Off.numOfElements-1)
       v = slang.Isolette_Data_Model.On_Off.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelOn_OffType.filter(v)) {
  ...
  def nextIsolette_Data_ModelRegulator_ModeType(): Isolette_Data_Model.Regulator_Mode.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.Isolette_Data_Model.Regulator_Mode.numOfElements-1)

    var v: Isolette_Data_Model.Regulator_Mode.Type = slang.Isolette_Data_Model.Regulator_Mode.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelRegulator_ModeType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelRegulator_ModeType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.Isolette_Data_Model.Regulator_Mode.numOfElements-1)
       v = slang.Isolette_Data_Model.Regulator_Mode.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelRegulator_ModeType.filter(v)) {
  ...
  def nextIsolette_Data_ModelStatusType(): Isolette_Data_Model.Status.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.Isolette_Data_Model.Status.numOfElements-1)

    var v: Isolette_Data_Model.Status.Type = slang.Isolette_Data_Model.Status.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelStatusType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelStatusType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.Isolette_Data_Model.Status.numOfElements-1)
       v = slang.Isolette_Data_Model.Status.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelStatusType.filter(v)) {
  ...
  def nextIsolette_Data_ModelValueStatusType(): Isolette_Data_Model.ValueStatus.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.Isolette_Data_Model.ValueStatus.numOfElements-1)

    var v: Isolette_Data_Model.ValueStatus.Type = slang.Isolette_Data_Model.ValueStatus.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelValueStatusType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelValueStatusType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.Isolette_Data_Model.ValueStatus.numOfElements-1)
       v = slang.Isolette_Data_Model.ValueStatus.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelValueStatusType.filter(v)) {
  ...
  def nextTempControlMixedFanAckType(): TempControlMixed.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixed.FanAck.numOfElements-1)

    var v: TempControlMixed.FanAck.Type = slang.TempControlMixed.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixed.FanAck.numOfElements-1)
       v = slang.TempControlMixed.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedFanAckType.filter(v)) {
  ...
  def nextTempControlMixedFanCmdType(): TempControlMixed.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixed.FanCmd.numOfElements-1)

    var v: TempControlMixed.FanCmd.Type = slang.TempControlMixed.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixed.FanCmd.numOfElements-1)
       v = slang.TempControlMixed.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedFanCmdType.filter(v)) {
  ...
  def nextTempControlMixedTempUnitType(): TempControlMixed.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixed.TempUnit.numOfElements-1)

    var v: TempControlMixed.TempUnit.Type = slang.TempControlMixed.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixed.TempUnit.numOfElements-1)
       v = slang.TempControlMixed.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedTempUnitType.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESFanAckType(): TempControlMixedSeL4CAmKES.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.FanAck.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.FanAck.Type = slang.TempControlMixedSeL4CAmKES.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.FanAck.numOfElements-1)
       v = slang.TempControlMixedSeL4CAmKES.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESFanAckType.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESFanCmdType(): TempControlMixedSeL4CAmKES.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.FanCmd.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.FanCmd.Type = slang.TempControlMixedSeL4CAmKES.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.FanCmd.numOfElements-1)
       v = slang.TempControlMixedSeL4CAmKES.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESFanCmdType.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESTempUnitType(): TempControlMixedSeL4CAmKES.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.TempUnit.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.TempUnit.Type = slang.TempControlMixedSeL4CAmKES.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlMixedSeL4CAmKES.TempUnit.numOfElements-1)
       v = slang.TempControlMixedSeL4CAmKES.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESTempUnitType.filter(v)) {
  ...
  def nextTempControlPeriodicFanAckType(): TempControlPeriodic.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlPeriodic.FanAck.numOfElements-1)

    var v: TempControlPeriodic.FanAck.Type = slang.TempControlPeriodic.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlPeriodic.FanAck.numOfElements-1)
       v = slang.TempControlPeriodic.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicFanAckType.filter(v)) {
  ...
  def nextTempControlPeriodicFanCmdType(): TempControlPeriodic.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlPeriodic.FanCmd.numOfElements-1)

    var v: TempControlPeriodic.FanCmd.Type = slang.TempControlPeriodic.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlPeriodic.FanCmd.numOfElements-1)
       v = slang.TempControlPeriodic.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicFanCmdType.filter(v)) {
  ...
  def nextTempControlPeriodicTempUnitType(): TempControlPeriodic.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.TempControlPeriodic.TempUnit.numOfElements-1)

    var v: TempControlPeriodic.TempUnit.Type = slang.TempControlPeriodic.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.TempControlPeriodic.TempUnit.numOfElements-1)
       v = slang.TempControlPeriodic.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicTempUnitType.filter(v)) {
  ...
  def nextruntimemonitorObservationKindType(): runtimemonitor.ObservationKind.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang.runtimemonitor.ObservationKind.numOfElements-1)

    var v: runtimemonitor.ObservationKind.Type = slang.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
    if(get_Config_runtimemonitorObservationKindType.attempts >= 0) {
     for(i <- 0 to get_Config_runtimemonitorObservationKindType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang.runtimemonitor.ObservationKind.numOfElements-1)
       v = slang.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_runtimemonitorObservationKindType.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_TempControlMixedSetPoint: Config_TempControlMixedSetPoint = Config_TempControlMixedSetPoint(100, _verbose, slang.TempControlMixed.SetPoint.D_Inv_SetPoint _)
  ...
  var config_TempControlMixedTemperature: Config_TempControlMixedTemperature = Config_TempControlMixedTemperature(100, _verbose, slang.TempControlMixed.Temperature.D_Inv_Temperature _)
  ...
  var config_TempControlMixedSeL4CAmKESSetPoint: Config_TempControlMixedSeL4CAmKESSetPoint = Config_TempControlMixedSeL4CAmKESSetPoint(100, _verbose, slang.TempControlMixedSeL4CAmKES.SetPoint.D_Inv_SetPoint _)
  ...
  var config_TempControlMixedSeL4CAmKESTemperature: Config_TempControlMixedSeL4CAmKESTemperature = Config_TempControlMixedSeL4CAmKESTemperature(100, _verbose, slang.TempControlMixedSeL4CAmKES.Temperature.D_Inv_Temperature _)
  ...
  var config_TempControlPeriodicSetPoint: Config_TempControlPeriodicSetPoint = Config_TempControlPeriodicSetPoint(100, _verbose, slang.TempControlPeriodic.SetPoint.D_Inv_SetPoint _)
  ...
  var config_TempControlPeriodicTemperature: Config_TempControlPeriodicTemperature = Config_TempControlPeriodicTemperature(100, _verbose, slang.TempControlPeriodic.Temperature.D_Inv_Temperature _)
