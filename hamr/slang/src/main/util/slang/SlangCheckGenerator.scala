...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS())
...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P())
...
@record class Gen_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(param: RandomLibI) extends MJen[TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS] {
  override def generate(f: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS())
