...
object MsgPack {
  ...
  object Constants {
    ...
    val Isolette_EnvironmentHeat: Z = -25

    val Isolette_EnvironmentHeat_Payload: Z = -24

    val Isolette_EnvironmentInterface_Interaction: Z = -23

    val Isolette_EnvironmentInterface_Interaction_Payload: Z = -22

    val Isolette_EnvironmentAir_Interaction: Z = -21

    val Isolette_EnvironmentAir_Interaction_Payload: Z = -20

    val TempControlMixedTemperature: Z = -19

    val TempControlMixedTemperature_Payload: Z = -18

    val TempControlMixedSetPoint: Z = -17

    val TempControlMixedSetPoint_Payload: Z = -16

    val TempControlMixedTempUnit_Payload: Z = -15

    val TempControlMixedFanCmd_Payload: Z = -14

    val TempControlMixedFanAck_Payload: Z = -13
    ...
    val TempControlMixedSeL4CAmKESTempSensor_tsp_tst_PreState_Container_P: Z = 24

    val TempControlMixedSeL4CAmKESTempSensor_tsp_tst_PreState_Container_PS: Z = 25

    val TempControlMixedSeL4CAmKESTempSensor_tsp_tst_PostState_Container_P: Z = 26

    val TempControlMixedSeL4CAmKESTempSensor_tsp_tst_PostState_Container_PS: Z = 27

    val TempControlMixedSeL4CAmKESTempControl_tcp_tct_PreState_Container_P: Z = 28

    val TempControlMixedSeL4CAmKESTempControl_tcp_tct_PreState_Container_PS: Z = 29

    val TempControlMixedSeL4CAmKESTempControl_tcp_tct_PostState_Container_P: Z = 30

    val TempControlMixedSeL4CAmKESTempControl_tcp_tct_PostState_Container_PS: Z = 31

    val TempControlMixedSeL4CAmKESFan_fp_ft_PreState_Container_P: Z = 32

    val TempControlMixedSeL4CAmKESFan_fp_ft_PreState_Container_PS: Z = 33

    val TempControlMixedSeL4CAmKESFan_fp_ft_PostState_Container_P: Z = 34

    val TempControlMixedSeL4CAmKESFan_fp_ft_PostState_Container_PS: Z = 35
