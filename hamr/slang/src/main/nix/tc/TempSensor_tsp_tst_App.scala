...
object TempSensor_tsp_tst_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.TempControlSystem_Instance_tsp_tst.entryPoints
  val appPortId: Art.PortId = IPCPorts.TempSensor_tsp_tst_App
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("TempSensor_tsp_tst_App starting ...")
