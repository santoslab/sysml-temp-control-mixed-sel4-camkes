...
class SystemTests extends SystemTestSuite {
  ...
  // import slang.TempControlMixedSeL4CAmKES.{TempSensor_tsp_ts_SystemTestAPI => nickname}
  // import slang.TempControlMixedSeL4CAmKES.{TempControl_tcp_tc_SystemTestAPI => nickname}
  // import slang.TempControlMixedSeL4CAmKES.{Fan_fp_f_SystemTestAPI => nickname}
