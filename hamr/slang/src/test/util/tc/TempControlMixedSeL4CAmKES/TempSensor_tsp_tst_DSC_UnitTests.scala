...
object TempSensor_tsp_tst_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempSensor_tsp_tst_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempSensor_tsp_tst_DSC_UnitTests extends TempSensor_tsp_tst_GumboX_UnitTests
