...
import org.sireum._
import slang.util.Profile
import slang.util.EmptyContainer
import slang.RandomLib

// Do not edit this file as it will be overwritten if HAMR codegen is rerun

// Profile for initialise entrypoint
@msig trait TempControl_tcp_tc_Profile_Trait extends Profile

@record class TempControl_tcp_tc_Profile (
  val name: String,
) extends TempControl_tcp_tc_Profile_Trait {
...
@msig trait TempControl_tcp_tc_Profile_P_Trait extends Profile {
...
@record class TempControl_tcp_tc_Profile_P(
  val name: String,
  ...
  ) extends TempControl_tcp_tc_Profile_P_Trait {

  override def next: TempControl_tcp_tc_PreState_Container_P = {
    return (TempControl_tcp_tc_PreState_Container_P (
...
@msig trait TempControl_tcp_tc_Profile_PS_Trait extends TempControl_tcp_tc_Profile_P_Trait {
...
@record class TempControl_tcp_tc_Profile_PS(
  val name: String,
  ...
  var api_setPoint: RandomLib, // random lib for generating TempControlMixedSeL4CAmKES.SetPoint
  var api_currentTemp: RandomLib // random lib for generating TempControlMixedSeL4CAmKES.Temperature
  ) extends TempControl_tcp_tc_Profile_PS_Trait {

  override def next: TempControl_tcp_tc_PreState_Container_PS = {
    return (TempControl_tcp_tc_PreState_Container_PS (
