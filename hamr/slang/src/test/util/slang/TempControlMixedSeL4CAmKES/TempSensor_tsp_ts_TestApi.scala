...
@msig trait TempSensor_tsp_ts_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.TempControlSystem_Instance_tsp_ts)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.TempControlSystem_Instance_tsp_ts)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.TempControlSystem_Instance_tsp_ts)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.TempControlSystem_Instance_tsp_ts)
  }

  /** helper function to check TempSensor_tsp_ts's
  ...
  def get_currentTemp_payload(): Option[TempControlMixedSeL4CAmKES.Temperature_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSystem_Instance_tsp_ts.initialization_api.currentTemp_Id).asInstanceOf[Option[TempControlMixedSeL4CAmKES.Temperature_Payload]]
  }
  ...
  def get_tempChanged_payload(): Option[art.Empty] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSystem_Instance_tsp_ts.initialization_api.tempChanged_Id).asInstanceOf[Option[art.Empty]]
  }
