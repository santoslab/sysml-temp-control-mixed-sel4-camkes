...
object TempControl_tcp_tc_SystemTestAPI {
  ...
  def fetchContainer(): slang.TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.TempControlSystem_Instance_tcp_tc.id)) {
      ...
      return postContainer_.asInstanceOf[slang.TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS]
    }
    else {
