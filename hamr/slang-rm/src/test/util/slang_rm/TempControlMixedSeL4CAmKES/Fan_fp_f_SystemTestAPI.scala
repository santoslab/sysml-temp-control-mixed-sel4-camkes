...
object Fan_fp_f_SystemTestAPI {
  ...
  def fetchContainer(): slang_rm.TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.TempControlSystem_Instance_fp_f.id)) {
      ...
      return postContainer_.asInstanceOf[slang_rm.TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS]
    }
    else {
