...
object TempControl_tcp_tc_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempControl_tcp_tc_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempControl_tcp_tc_DSC_UnitTests extends TempControl_tcp_tc_GumboX_UnitTests
