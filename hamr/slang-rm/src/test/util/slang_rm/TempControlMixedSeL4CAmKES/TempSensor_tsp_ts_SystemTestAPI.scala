...
object TempSensor_tsp_ts_SystemTestAPI {
  ...
  def fetchContainer(): slang_rm.TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.TempControlSystem_Instance_tsp_ts.id)) {
      ...
      return postContainer_.asInstanceOf[slang_rm.TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS]
    }
    else {
