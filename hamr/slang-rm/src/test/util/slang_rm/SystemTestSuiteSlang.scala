...
import slang_rm.SystemTestSuiteSlang._
import slang_rm.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: slang_rm.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: slang_rm.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
