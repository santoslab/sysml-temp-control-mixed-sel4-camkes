...
class SystemTests extends SystemTestSuite {
  ...
  // import slang_rm.TempControlMixedSeL4CAmKES.{TempSensor_tsp_ts_SystemTestAPI => nickname}
  // import slang_rm.TempControlMixedSeL4CAmKES.{TempControl_tcp_tc_SystemTestAPI => nickname}
  // import slang_rm.TempControlMixedSeL4CAmKES.{Fan_fp_f_SystemTestAPI => nickname}
