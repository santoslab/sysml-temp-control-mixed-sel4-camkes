...
import tc.TempControlMixedSeL4CAmKES.Fan_fp_ft_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Fan_fp_ft_GumboX_UnitTests extends Fan_fp_ft_GumboX_TestHarness_ScalaTest {
    ...
    def next: Option[Container] = {
      try {
        c.profile.next match {
          case (cp: Fan_fp_ft_PreState_Container) =>
