...
import slang_rm.TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class TempSensor_tsp_ts_GumboX_UnitTests extends TempSensor_tsp_ts_GumboX_TestHarness_ScalaTest {
