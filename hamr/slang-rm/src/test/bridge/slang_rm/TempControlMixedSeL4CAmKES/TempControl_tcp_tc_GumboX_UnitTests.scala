...
import slang_rm.util.{Container, UnitTestConfigurationBatch}
import slang_rm.TempControlMixedSeL4CAmKES.TempControl_tcp_tc_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class TempControl_tcp_tc_GumboX_UnitTests extends TempControl_tcp_tc_GumboX_TestHarness_ScalaTest {
    ...
    def next: Option[Container] = {
      try {
        c.profile.next match {
          case (cp: TempControl_tcp_tc_PreState_Container) =>
