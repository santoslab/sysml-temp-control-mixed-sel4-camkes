...
import slang_rm.TempControlMixedSeL4CAmKES.Fan_fp_f_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Fan_fp_f_GumboX_UnitTests extends Fan_fp_f_GumboX_TestHarness_ScalaTest {
