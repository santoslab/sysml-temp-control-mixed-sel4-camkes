...
object TempControl_tcp_tc_GumboX {
  /** I-Assm: Integration constraint on tc's incoming data port currentTemp
    *
  ...
  // I-Assm-Guard: Integration constraint on tc's incoming data port currentTemp
  ...
  /** IEP-Guar: Initialize Entrypoint Contracts for tc
    *
    * @param currentFanState post-state state variable
    * @param currentSetPoint post-state state variable
    * @param latestTemp post-state state variable
  ...
  @strictpure def inititialize_IEP_Post (
      ...
      latestTemp: TempControlMixedSeL4CAmKES.Temperature,
      api_fanCmd: Option[TempControlMixedSeL4CAmKES.FanCmd.Type]): B =
    (// D-Inv-Guard: Datatype invariants for the types associated with tc's state variables and outgoing ports
     ...
     // IEP-Guar: Initialize Entrypoint contract for tc
  ...
  /** IEP-Post: Initialize Entrypoint Post-Condition via container
    ...
    */
  @strictpure def inititialize_IEP_Post_Container (post: TempControl_tcp_tc_PostState_Container_PS): B =
  ...
  /** CEP-T-Assm: Top-level assume contracts for tc's compute entrypoint
    *
    * @param In_currentFanState pre-state state variable
    * @param In_currentSetPoint pre-state state variable
    * @param In_latestTemp pre-state state variable
  ...
  /** CEP-Pre: Compute Entrypoint Pre-Condition for tc
    *
    * @param In_currentFanState pre-state state variable
    * @param In_currentSetPoint pre-state state variable
    * @param In_latestTemp pre-state state variable
  ...
  @strictpure def compute_CEP_Pre (
    ...
    (// D-Inv-Guard: Datatype invariants for the types associated with tc's state variables and incoming ports
     ...
     // I-Assm-Guard: Integration constraints for tc's incoming ports
     I_Assm_Guard_currentTemp(api_currentTemp) & 

     // CEP-Assm: assume clauses of tc's compute entrypoint
     compute_CEP_T_Assm (In_currentFanState, In_currentSetPoint, In_latestTemp))

  /** CEP-Pre: Compute Entrypoint Pre-Condition for tc via container
    *
    * @param pre Container holding the value of incoming ports and the pre-state values of state variables
    */
  @strictpure def compute_CEP_Pre_Container(pre: TempControl_tcp_tc_PreState_Container_PS): B =
    compute_CEP_Pre(
  ...
  @strictpure def compute_spec_mustSendFanCmd_guarantee(
      ...
      currentFanState: TempControlMixedSeL4CAmKES.FanCmd.Type,
      api_fanCmd: Option[TempControlMixedSeL4CAmKES.FanCmd.Type]): B =
    In_currentFanState != currentFanState ___>:
      api_fanCmd.nonEmpty &&
        api_fanCmd.get == currentFanState &&
        currentFanState == In_currentFanState ___>:
        api_fanCmd.isEmpty

  /** CEP-T-Guar: Top-level guarantee contracts for tc's compute entrypoint
    *
    * @param In_currentFanState pre-state state variable
    * @param currentFanState post-state state variable
    * @param currentSetPoint post-state state variable
  ...
  /** CEP-T-Handle_setPoint_Guar: Top-level guarantee contracts for tc's compute setPoint handler
    *
    * @param In_latestTemp pre-state state variable
    * @param currentSetPoint post-state state variable
    * @param latestTemp post-state state variable
  ...
  /** CEP-T-Handle_tempChanged_Guar: Top-level guarantee contracts for tc's compute tempChanged handler
    *
    * @param In_currentSetPoint pre-state state variable
    * @param currentSetPoint post-state state variable
    * @param latestTemp post-state state variable
  ...
  /** CEP-T-Handle_fanAck_Guar: Top-level guarantee contracts for tc's compute fanAck handler
    *
    * @param In_currentFanState pre-state state variable
    * @param In_currentSetPoint pre-state state variable
    * @param In_latestTemp pre-state state variable
  ...
  /** CEP-Post: Compute Entrypoint Post-Condition for tc
    *
    * @param In_currentFanState pre-state state variable
    * @param In_currentSetPoint pre-state state variable
    * @param In_latestTemp pre-state state variable
  ...
  @strictpure def compute_CEP_Post (
    ...
    (// D-Inv-Guard: Datatype invariants for the types associated with tc's state variables and outgoing ports
     ...
     // CEP-Guar: guarantee clauses of tc's compute entrypoint
     compute_CEP_T_Guar (In_currentFanState, currentFanState, currentSetPoint, latestTemp, api_fanCmd) & 

     // CEP-T-Handlers: handler clauses of tc's compute entrypoint
  ...
  /** CEP-Post: Compute Entrypoint Post-Condition for tc via containers
    *
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: TempControl_tcp_tc_PreState_Container_PS,
      post: TempControl_tcp_tc_PostState_Container_PS): B =
    compute_CEP_Post(
      In_currentFanState = pre.In_currentFanState,
      In_currentSetPoint = pre.In_currentSetPoint,
      In_latestTemp = pre.In_latestTemp,
