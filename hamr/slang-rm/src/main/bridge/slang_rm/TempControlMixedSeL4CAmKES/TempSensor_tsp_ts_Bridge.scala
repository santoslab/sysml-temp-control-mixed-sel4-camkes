...
import art._
import slang_rm._
import slang_rm.TempControlMixedSeL4CAmKES.{TempSensor_tsp_ts => component}

// Do not edit this file as it will be overwritten if HAMR codegen is rerun

@datatype class TempSensor_tsp_ts_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : TempSensor_Initialization_Api = {
    ...
    TempSensor_tsp_ts_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : TempSensor_Operational_Api = {
    ...
    TempSensor_tsp_ts_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    TempSensor_tsp_ts_Bridge.EntryPoints(
      id,
...
object TempSensor_tsp_ts_Bridge {
  ...
  @datatype class EntryPoints(
    TempSensor_tsp_ts_BridgeId : Art.BridgeId,
    ...
    def initialise(): Unit = {
      TempSensor_tsp_ts_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: TempSensor_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      TempSensor_tsp_ts_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      TempSensor_tsp_ts_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      TempSensor_tsp_ts_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: TempSensor_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      TempSensor_tsp_ts_EntryPoint_Companion.post_compute()
