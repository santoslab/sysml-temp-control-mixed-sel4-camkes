...
import art._
import tc._
import tc.TempControlMixedSeL4CAmKES.{Fan_fp_ft => component}

// Do not edit this file as it will be overwritten if HAMR codegen is rerun

@datatype class Fan_fp_ft_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Fan_Initialization_Api = {
    ...
    Fan_fp_ft_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Fan_Operational_Api = {
    ...
    Fan_fp_ft_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Fan_fp_ft_Bridge.EntryPoints(
      id,
...
object Fan_fp_ft_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Fan_fp_ft_BridgeId)
      ...
      Fan_fp_ft_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      for(portId <- dispatchableEventPorts) {
        if(portId == fanCmd_Id){
          val Some(TempControlMixedSeL4CAmKES.FanCmd_Payload(value)) = Art.getValue(fanCmd_Id)

          Fan_fp_ft_EntryPoint_Companion.pre_compute(fanCmd_Id)

          // implement the following in 'component':  def handle_fanCmd(api: Fan_Operational_Api, value: TempControlMixedSeL4CAmKES.FanCmd.Type): Unit = {}
          component.handle_fanCmd(operational_api, value)

          Fan_fp_ft_EntryPoint_Companion.post_compute()
        }
      }
