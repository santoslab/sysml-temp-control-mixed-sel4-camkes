...
object Arch {
  val TempControlSystem_Instance_tsp_ts : slang_rm.TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_Bridge = {
    ...
    slang_rm.TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_Bridge(
      id = bridgeId"0",
  ...
  val TempControlSystem_Instance_tcp_tc : slang_rm.TempControlMixedSeL4CAmKES.TempControl_tcp_tc_Bridge = {
    ...
    slang_rm.TempControlMixedSeL4CAmKES.TempControl_tcp_tc_Bridge(
      id = bridgeId"1",
  ...
  val TempControlSystem_Instance_fp_f : slang_rm.TempControlMixedSeL4CAmKES.Fan_fp_f_Bridge = {
    ...
    slang_rm.TempControlMixedSeL4CAmKES.Fan_fp_f_Bridge(
      id = bridgeId"2",
