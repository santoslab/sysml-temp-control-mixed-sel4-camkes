...
@msig trait RandomLibI {
  ...
  def next_artDataContent(): art.DataContent = {
    ...
    var v: art.DataContent = c match {
      ...
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS _).apply()
      ...
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P _).apply()
      case _artDataContent_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS _).apply()
  ...
  def nextIsolette_Data_ModelMonitor_ModeType(): Isolette_Data_Model.Monitor_Mode.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Monitor_Mode.numOfElements-1)

    var v: Isolette_Data_Model.Monitor_Mode.Type = slang_rm.Isolette_Data_Model.Monitor_Mode.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelMonitor_ModeType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelMonitor_ModeType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Monitor_Mode.numOfElements-1)
       v = slang_rm.Isolette_Data_Model.Monitor_Mode.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelMonitor_ModeType.filter(v)) {
  ...
  def nextIsolette_Data_ModelOn_OffType(): Isolette_Data_Model.On_Off.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.Isolette_Data_Model.On_Off.numOfElements-1)

    var v: Isolette_Data_Model.On_Off.Type = slang_rm.Isolette_Data_Model.On_Off.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelOn_OffType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelOn_OffType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.Isolette_Data_Model.On_Off.numOfElements-1)
       v = slang_rm.Isolette_Data_Model.On_Off.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelOn_OffType.filter(v)) {
  ...
  def nextIsolette_Data_ModelRegulator_ModeType(): Isolette_Data_Model.Regulator_Mode.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Regulator_Mode.numOfElements-1)

    var v: Isolette_Data_Model.Regulator_Mode.Type = slang_rm.Isolette_Data_Model.Regulator_Mode.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelRegulator_ModeType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelRegulator_ModeType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Regulator_Mode.numOfElements-1)
       v = slang_rm.Isolette_Data_Model.Regulator_Mode.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelRegulator_ModeType.filter(v)) {
  ...
  def nextIsolette_Data_ModelStatusType(): Isolette_Data_Model.Status.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Status.numOfElements-1)

    var v: Isolette_Data_Model.Status.Type = slang_rm.Isolette_Data_Model.Status.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelStatusType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelStatusType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.Isolette_Data_Model.Status.numOfElements-1)
       v = slang_rm.Isolette_Data_Model.Status.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelStatusType.filter(v)) {
  ...
  def nextIsolette_Data_ModelValueStatusType(): Isolette_Data_Model.ValueStatus.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.Isolette_Data_Model.ValueStatus.numOfElements-1)

    var v: Isolette_Data_Model.ValueStatus.Type = slang_rm.Isolette_Data_Model.ValueStatus.byOrdinal(ordinal).get
    if(get_Config_Isolette_Data_ModelValueStatusType.attempts >= 0) {
     for(i <- 0 to get_Config_Isolette_Data_ModelValueStatusType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.Isolette_Data_Model.ValueStatus.numOfElements-1)
       v = slang_rm.Isolette_Data_Model.ValueStatus.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Isolette_Data_ModelValueStatusType.filter(v)) {
  ...
  def nextTempControlMixedFanAckType(): TempControlMixed.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixed.FanAck.numOfElements-1)

    var v: TempControlMixed.FanAck.Type = slang_rm.TempControlMixed.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixed.FanAck.numOfElements-1)
       v = slang_rm.TempControlMixed.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedFanAckType.filter(v)) {
  ...
  def nextTempControlMixedFanCmdType(): TempControlMixed.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixed.FanCmd.numOfElements-1)

    var v: TempControlMixed.FanCmd.Type = slang_rm.TempControlMixed.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixed.FanCmd.numOfElements-1)
       v = slang_rm.TempControlMixed.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedFanCmdType.filter(v)) {
  ...
  def nextTempControlMixedTempUnitType(): TempControlMixed.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixed.TempUnit.numOfElements-1)

    var v: TempControlMixed.TempUnit.Type = slang_rm.TempControlMixed.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixed.TempUnit.numOfElements-1)
       v = slang_rm.TempControlMixed.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedTempUnitType.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESFanAckType(): TempControlMixedSeL4CAmKES.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.FanAck.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.FanAck.Type = slang_rm.TempControlMixedSeL4CAmKES.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.FanAck.numOfElements-1)
       v = slang_rm.TempControlMixedSeL4CAmKES.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESFanAckType.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESFanCmdType(): TempControlMixedSeL4CAmKES.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.FanCmd.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.FanCmd.Type = slang_rm.TempControlMixedSeL4CAmKES.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.FanCmd.numOfElements-1)
       v = slang_rm.TempControlMixedSeL4CAmKES.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESFanCmdType.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(): TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P_Id, TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container = c match {
      case TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(): TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P = {
    var api_fanCmd: Option[TempControlMixedSeL4CAmKES.FanCmd.Type] = nextOptionTempControlMixedSeL4CAmKESFanCmdType()

    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P = TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P(api_fanCmd)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_fanCmd = nextOptionTempControlMixedSeL4CAmKESFanCmdType()
        v = TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P(api_fanCmd)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(): TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS = {
    var api_fanCmd: Option[TempControlMixedSeL4CAmKES.FanCmd.Type] = nextOptionTempControlMixedSeL4CAmKESFanCmdType()

    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS = TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS(api_fanCmd)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_fanCmd = nextOptionTempControlMixedSeL4CAmKESFanCmdType()
        v = TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS(api_fanCmd)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(): TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P_Id, TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container = c match {
      case TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(): TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P = {
    var api_fanAck: Option[TempControlMixedSeL4CAmKES.FanAck.Type] = nextOptionTempControlMixedSeL4CAmKESFanAckType()

    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P = TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P(api_fanAck)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_fanAck = nextOptionTempControlMixedSeL4CAmKESFanAckType()
        v = TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P(api_fanAck)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS ===================

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(): TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS = {
    var api_fanAck: Option[TempControlMixedSeL4CAmKES.FanAck.Type] = nextOptionTempControlMixedSeL4CAmKESFanAckType()

    var v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS = TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS(api_fanAck)

    if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_fanAck = nextOptionTempControlMixedSeL4CAmKESFanAckType()
        v = TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS(api_fanAck)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P_Id, TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container = c match {
      case TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P = {
    ...
    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P(api_tempChanged, api_fanAck, api_setPoint, api_currentTemp)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        ...
        v = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P(api_tempChanged, api_fanAck, api_setPoint, api_currentTemp)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS = {
    ...
    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS(In_currentFanState, In_currentSetPoint, In_latestTemp, api_tempChanged, api_fanAck, api_setPoint, api_currentTemp)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        ...
        api_setPoint = nextOptionTempControlMixedSeL4CAmKESSetPoint()
        api_currentTemp = nextTempControlMixedSeL4CAmKESTemperature()
        v = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS(In_currentFanState, In_currentSetPoint, In_latestTemp, api_tempChanged, api_fanAck, api_setPoint, api_currentTemp)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P_Id, TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container = c match {
      case TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P = {
    var api_fanCmd: Option[TempControlMixedSeL4CAmKES.FanCmd.Type] = nextOptionTempControlMixedSeL4CAmKESFanCmdType()

    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P(api_fanCmd)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_fanCmd = nextOptionTempControlMixedSeL4CAmKESFanCmdType()
        v = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P(api_fanCmd)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS ===================

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(): TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS = {
    ...
    var v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS(currentFanState, currentSetPoint, latestTemp, api_fanCmd)

    if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        ...
        api_fanCmd = nextOptionTempControlMixedSeL4CAmKESFanCmdType()
        v = TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS(currentFanState, currentSetPoint, latestTemp, api_fanCmd)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P_Id, TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container = c match {
      case TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P = {

    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P()

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        v = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P()
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P.filter(v)) {
  ...
  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS = {

    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS()

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        v = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS()
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container ===================

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container = {
    var callEnum: ISZ[TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.Type] = ISZ(TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P_Id, TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS_Id)

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.additiveTypeFiltering) {
       callEnum = get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.typeFilter
    } else {
       for(h <- get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.typeFilter) {
         callEnum = ops.ISZOps(callEnum).filter(f => h =!= f)
       }
    }
    ...
    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container = c match {
      case TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P _).apply()
      case TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS _).apply()
      case _ => halt("Invalid Child")
    }


    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.attempts) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.filter(v)) {
        return v
       }
       if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container.verbose) {
         println(s"Retrying for failing value: $v")
       }
       c = callEnum(gen.nextZBetween(0, callEnum.size-1))
  ...
  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P ===================

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P = {
    var api_tempChanged: Option[art.Empty] = nextOption_artEmpty()
    var api_currentTemp: TempControlMixedSeL4CAmKES.Temperature = nextTempControlMixedSeL4CAmKESTemperature()

    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P(api_tempChanged, api_currentTemp)

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_tempChanged = nextOption_artEmpty()
        api_currentTemp = nextTempControlMixedSeL4CAmKESTemperature()
        v = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P(api_tempChanged, api_currentTemp)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P.filter(v)) {
  ...
  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS ===================

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS
  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS): RandomLib

  def nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(): TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS = {
    var api_tempChanged: Option[art.Empty] = nextOption_artEmpty()
    var api_currentTemp: TempControlMixedSeL4CAmKES.Temperature = nextTempControlMixedSeL4CAmKESTemperature()

    var v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS(api_tempChanged, api_currentTemp)

    if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS.attempts) {
        if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS.filter(v)) {
          return v
        }
        if (get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS.verbose) {
          println(s"Retrying for failing value: $v")
        }
        api_tempChanged = nextOption_artEmpty()
        api_currentTemp = nextTempControlMixedSeL4CAmKESTemperature()
        v = TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS(api_tempChanged, api_currentTemp)
     }
    } else {
     while(T) {
       if(get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS.filter(v)) {
  ...
  def nextTempControlMixedSeL4CAmKESTempUnitType(): TempControlMixedSeL4CAmKES.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.TempUnit.numOfElements-1)

    var v: TempControlMixedSeL4CAmKES.TempUnit.Type = slang_rm.TempControlMixedSeL4CAmKES.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlMixedSeL4CAmKESTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlMixedSeL4CAmKESTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlMixedSeL4CAmKES.TempUnit.numOfElements-1)
       v = slang_rm.TempControlMixedSeL4CAmKES.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlMixedSeL4CAmKESTempUnitType.filter(v)) {
  ...
  def nextTempControlPeriodicFanAckType(): TempControlPeriodic.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlPeriodic.FanAck.numOfElements-1)

    var v: TempControlPeriodic.FanAck.Type = slang_rm.TempControlPeriodic.FanAck.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicFanAckType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicFanAckType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlPeriodic.FanAck.numOfElements-1)
       v = slang_rm.TempControlPeriodic.FanAck.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicFanAckType.filter(v)) {
  ...
  def nextTempControlPeriodicFanCmdType(): TempControlPeriodic.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlPeriodic.FanCmd.numOfElements-1)

    var v: TempControlPeriodic.FanCmd.Type = slang_rm.TempControlPeriodic.FanCmd.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicFanCmdType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicFanCmdType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlPeriodic.FanCmd.numOfElements-1)
       v = slang_rm.TempControlPeriodic.FanCmd.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicFanCmdType.filter(v)) {
  ...
  def nextTempControlPeriodicTempUnitType(): TempControlPeriodic.TempUnit.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.TempControlPeriodic.TempUnit.numOfElements-1)

    var v: TempControlPeriodic.TempUnit.Type = slang_rm.TempControlPeriodic.TempUnit.byOrdinal(ordinal).get
    if(get_Config_TempControlPeriodicTempUnitType.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlPeriodicTempUnitType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.TempControlPeriodic.TempUnit.numOfElements-1)
       v = slang_rm.TempControlPeriodic.TempUnit.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_TempControlPeriodicTempUnitType.filter(v)) {
  ...
  def nextutilContainer(): util.Container = {
    var callEnum: ISZ[utilContainer_DataTypeId.Type] = ISZ(utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P_Id, utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS_Id, utilContainer_DataTypeId.utilEmptyContainer_Id)
    ...
    var v: util.Container = c match {
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS_Id => (nextTempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS _).apply()
  ...
  def nextruntimemonitorObservationKindType(): runtimemonitor.ObservationKind.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, slang_rm.runtimemonitor.ObservationKind.numOfElements-1)

    var v: runtimemonitor.ObservationKind.Type = slang_rm.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
    if(get_Config_runtimemonitorObservationKindType.attempts >= 0) {
     for(i <- 0 to get_Config_runtimemonitorObservationKindType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, slang_rm.runtimemonitor.ObservationKind.numOfElements-1)
       v = slang_rm.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_runtimemonitorObservationKindType.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_TempControlMixedSetPoint: Config_TempControlMixedSetPoint = Config_TempControlMixedSetPoint(100, _verbose, slang_rm.TempControlMixed.SetPoint.D_Inv_SetPoint _)
  ...
  var config_TempControlMixedTemperature: Config_TempControlMixedTemperature = Config_TempControlMixedTemperature(100, _verbose, slang_rm.TempControlMixed.Temperature.D_Inv_Temperature _)
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container = Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container = config
    return this
  }
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P = Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PreState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS = Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PreState_Container_PS = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container = Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container = config
    return this
  }
  ...
  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P = Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(v: TempControlMixedSeL4CAmKES.Fan_fp_f_PostState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS = Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS = {return config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESFan_fp_f_PostState_Container_PS = config
    return this
  }
  ...
  var config_TempControlMixedSeL4CAmKESSetPoint: Config_TempControlMixedSeL4CAmKESSetPoint = Config_TempControlMixedSeL4CAmKESSetPoint(100, _verbose, slang_rm.TempControlMixedSeL4CAmKES.SetPoint.D_Inv_SetPoint _)
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container = config
    return this
  }
  ...
  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PreState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PreState_Container_PS = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(v: TempControlMixedSeL4CAmKES.TempControl_tcp_tc_PostState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS = Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS = {return config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempControl_tcp_tc_PostState_Container_PS = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PreState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PreState_Container_PS = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(100, _verbose, F, ISZ(), alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_P): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_P = config
    return this
  }

  // ============= TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS ===================
  def alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(v: TempControlMixedSeL4CAmKES.TempSensor_tsp_ts_PostState_Container_PS): B = {return T}

  var config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS = Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(100, _verbose, alwaysTrue_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS _)

  def get_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS = {return config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS}

  def set_Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS(config: Config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS): RandomLib ={
    config_TempControlMixedSeL4CAmKESTempSensor_tsp_ts_PostState_Container_PS = config
    return this
  }
  ...
  var config_TempControlMixedSeL4CAmKESTemperature: Config_TempControlMixedSeL4CAmKESTemperature = Config_TempControlMixedSeL4CAmKESTemperature(100, _verbose, slang_rm.TempControlMixedSeL4CAmKES.Temperature.D_Inv_Temperature _)
  ...
  var config_TempControlPeriodicSetPoint: Config_TempControlPeriodicSetPoint = Config_TempControlPeriodicSetPoint(100, _verbose, slang_rm.TempControlPeriodic.SetPoint.D_Inv_SetPoint _)
  ...
  var config_TempControlPeriodicTemperature: Config_TempControlPeriodicTemperature = Config_TempControlPeriodicTemperature(100, _verbose, slang_rm.TempControlPeriodic.Temperature.D_Inv_Temperature _)
