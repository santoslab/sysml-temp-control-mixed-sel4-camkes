...
object Fan_fp_f_EntryPoint_Companion {
  ...
  def post_initialise(): Unit = {
    ...
    slang_rm.runtimemonitor.RuntimeMonitor.observeInitialisePostState(Arch.TempControlSystem_Instance_fp_f.id, slang_rm.runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_f_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    slang_rm.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.TempControlSystem_Instance_fp_f.id, slang_rm.runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_f_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    slang_rm.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.TempControlSystem_Instance_fp_f.id, slang_rm.runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_f_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}