...
// This file is auto-generated from Temperature.scala, TempUnit.scala, SetPoint.scala, FanCmd.scala, FanAck.scala, Heat.scala, Interface_Interaction.scala, Air_Interaction.scala, Temperature.scala, SetPoint.scala, TempUnit.scala, FanCmd.scala, FanAck.scala, Temperature.scala, SetPoint.scala, TempUnit.scala, FanCmd.scala, FanAck.scala, PhysicalTemp.scala, TempWstatus.scala, Temp.scala, On_Off.scala, Failure_Flag.scala, ValueStatus.scala, Status.scala, Regulator_Mode.scala, Monitor_Mode.scala, Base_Types.scala, GUMBO__Library.scala, GUMBO__Library.scala, GUMBO__Library.scala, GUMBO__Library.scala, TempSensor_tsp_tst_Containers.scala, TempControl_tcp_tct_Containers.scala, Fan_fp_ft_Containers.scala, ObservationKind.scala, Container.scala, DataContent.scala, Aux_Types.scala
...
object JSON {
  ...
  object Printer {
    ...
    @pure def printruntimemonitorObservationKindType(o: runtimemonitor.ObservationKind.Type): ST = {
      val value: String = o match {
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tsp_tst_postInit => "TempControlSystem_Instance_tsp_tst_postInit"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tsp_tst_preCompute => "TempControlSystem_Instance_tsp_tst_preCompute"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tsp_tst_postCompute => "TempControlSystem_Instance_tsp_tst_postCompute"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tcp_tct_postInit => "TempControlSystem_Instance_tcp_tct_postInit"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tcp_tct_preCompute => "TempControlSystem_Instance_tcp_tct_preCompute"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_tcp_tct_postCompute => "TempControlSystem_Instance_tcp_tct_postCompute"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_ft_postInit => "TempControlSystem_Instance_fp_ft_postInit"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_ft_preCompute => "TempControlSystem_Instance_fp_ft_preCompute"
        case runtimemonitor.ObservationKind.TempControlSystem_Instance_fp_ft_postCompute => "TempControlSystem_Instance_fp_ft_postCompute"
      }
      return printObject(ISZ(
