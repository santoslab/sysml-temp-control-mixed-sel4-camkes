...
//     sireum proyek run . slang_rm.Demo
//
//   To see the available CLI options:
//     sireum proyek run . slang_rm.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main slang_rm.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/slang_rm/Demo.scala and choose "Run 'Demo'"
//
