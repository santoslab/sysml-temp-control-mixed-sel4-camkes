...
#include <sb_TempControl.h>
#include <sb_event_counter.h>
#include <sb_queue_union_art_DataContent_1.h>
#include <sb_event_counter.h>
#include <sb_queue_union_art_DataContent_1.h>
#include <TempControl_tcp_tc_adapter.h>
#include <string.h>
#include <camkes.h>
...
void sb_freeze_event_port_tempChanged() {
  ...
  if(sb_tempChanged_received_events > 0) {
    ...
    if(sb_tempChanged_received_events > 1) {
      //printf("TempControl: dropping %i event(s) from incoming event port tempChanged\n", (sb_tempChanged_received_events - 1));
...
// send fanCmd: Out EventDataPort TempControlMixedSeL4CAmKES__FanCmd
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_fanCmd_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_fanCmd_Send", 0);

  sb_fanCmd_enqueue(d);
}

// is_empty currentTemp: In DataPort
B tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_currentTemp_IsEmpty(STACK_FRAME_ONLY) {
  return sb_currentTemp_is_empty();
}

// receive currentTemp: In DataPort union_art_DataContent
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_currentTemp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_currentTemp_Receive", 0);
...
B tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_tempChanged_IsEmpty(STACK_FRAME_ONLY) {
  return sb_tempChanged_is_empty();
}

// receive tempChanged: In EventPort
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_tempChanged_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_tempChanged_Receive", 0);
...
B tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_fanAck_IsEmpty(STACK_FRAME_ONLY) {
  return sb_fanAck_is_empty();
}

// receive fanAck: In EventDataPort union_art_DataContent
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_fanAck_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_fanAck_Receive", 0);
...
B tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_setPoint_IsEmpty(STACK_FRAME_ONLY) {
  return T;
}

// FIXME: dummy implementation for unconnected incoming port
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_setPoint_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_seL4Nix_setPoint_Receive", 0);
...
void pre_init(void) {
  DeclNewStackFrame(NULL, "sb_TempControl.c", "", "pre_init", 0);

  printf("Entering pre-init of TempControl_tcp_tc\n");
  ...
  tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of TempControl_tcp_tc\n");
}

void post_init(void) {
  DeclNewStackFrame(NULL, "sb_TempControl.c", "", "post_init", 0);
 ...
 ************************************************************************/
int run(void) {
  DeclNewStackFrame(NULL, "sb_TempControl.c", "", "run", 0);
  ...
  for(;;) {
    ...
    tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tc_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
