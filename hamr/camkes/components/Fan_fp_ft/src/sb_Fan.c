...
Unit tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_seL4Nix_fanAck_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Fan.c", "", "tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_seL4Nix_fanAck_Send", 0);
...
Unit tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_seL4Nix_fanCmd_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Fan.c", "", "tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_seL4Nix_fanCmd_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of Fan_fp_ft\n");
  ...
  tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of Fan_fp_ft\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
