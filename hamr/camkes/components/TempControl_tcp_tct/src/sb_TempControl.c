...
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_fanCmd_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_fanCmd_Send", 0);

  sb_fanCmd_enqueue(d);
}

// is_empty currentTemp: In DataPort
B tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_currentTemp_IsEmpty(STACK_FRAME_ONLY) {
  return sb_currentTemp_is_empty();
}

// receive currentTemp: In DataPort union_art_DataContent
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_currentTemp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_currentTemp_Receive", 0);
...
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_tempChanged_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_tempChanged_Receive", 0);
...
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_fanAck_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_fanAck_Receive", 0);
...
// FIXME: dummy implementation for unconnected incoming port
Unit tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_setPoint_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl.c", "", "tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_seL4Nix_setPoint_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of TempControl_tcp_tct\n");
  ...
  tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of TempControl_tcp_tct\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    tc_TempControlMixedSeL4CAmKES_TempControl_tcp_tct_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
