...
B art_Port_AE5929__ne(art_Port_AE5929 this, art_Port_AE5929 other);
B art_Port_AE5929__inequiv(art_Port_AE5929 this, art_Port_AE5929 other);
...
B art_Port_AE5929__is(STACK_FRAME void* this);
art_Port_AE5929 art_Port_AE5929__as(STACK_FRAME void *this);

void art_Port_AE5929_apply(STACK_FRAME art_Port_AE5929 this, art_Art_PortId id, String name, art_PortMode_Type mode) {
  DeclNewStackFrame(caller, "ArchitectureDescription.scala", "art.art_Port_AE5929", "apply", 0);
  this->id = id;
