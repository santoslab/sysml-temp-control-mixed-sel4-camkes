...
B Some_4782C6__equiv(Some_4782C6 this, Some_4782C6 other) {
  if (art_Empty__inequiv((art_Empty) &this->value, (art_Empty) &other->value)) return F;
  return T;
}

B Some_4782C6__ne(Some_4782C6 this, Some_4782C6 other);
B Some_4782C6__inequiv(Some_4782C6 this, Some_4782C6 other);
