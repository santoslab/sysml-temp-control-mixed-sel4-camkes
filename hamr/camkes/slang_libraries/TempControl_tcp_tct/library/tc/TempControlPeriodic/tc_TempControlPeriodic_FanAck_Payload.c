...
B tc_TempControlPeriodic_FanAck_Payload__ne(tc_TempControlPeriodic_FanAck_Payload this, tc_TempControlPeriodic_FanAck_Payload other);
B tc_TempControlPeriodic_FanAck_Payload__inequiv(tc_TempControlPeriodic_FanAck_Payload this, tc_TempControlPeriodic_FanAck_Payload other);

void tc_TempControlPeriodic_FanAck_Payload_string_(STACK_FRAME String result, tc_TempControlPeriodic_FanAck_Payload this) {
  DeclNewStackFrame(caller, "FanAck.scala", "tc.TempControlPeriodic.FanAck_Payload", "string", 0);
...
B tc_TempControlPeriodic_FanAck_Payload__is(STACK_FRAME void* this);
tc_TempControlPeriodic_FanAck_Payload tc_TempControlPeriodic_FanAck_Payload__as(STACK_FRAME void *this);
...
void tc_TempControlPeriodic_FanAck_Payload_apply(STACK_FRAME tc_TempControlPeriodic_FanAck_Payload this, tc_TempControlPeriodic_FanAck_Type value) {
  DeclNewStackFrame(caller, "FanAck.scala", "tc.TempControlPeriodic.FanAck_Payload", "apply", 0);
  this->value = value;
}