...
U32 Random_Gen64Impl_nextU32_(STACK_FRAME Random_Gen64Impl this) {
  DeclNewStackFrame(caller, "Random.scala", "org.sireum.Random.Gen64", "nextU32", 0);
  U64 t_0 = Random_Gen64Impl_nextU64_(SF this);
  Z t_1 = U64_toZ_(SF U64__ushr(t_0, U64_C(32)));
  return U32_fromZ(SF t_1);
}
