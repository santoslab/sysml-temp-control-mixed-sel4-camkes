...
B tc_TempControlMixed_FanCmd_Payload__ne(tc_TempControlMixed_FanCmd_Payload this, tc_TempControlMixed_FanCmd_Payload other);
B tc_TempControlMixed_FanCmd_Payload__inequiv(tc_TempControlMixed_FanCmd_Payload this, tc_TempControlMixed_FanCmd_Payload other);

void tc_TempControlMixed_FanCmd_Payload_string_(STACK_FRAME String result, tc_TempControlMixed_FanCmd_Payload this) {
  DeclNewStackFrame(caller, "FanCmd.scala", "tc.TempControlMixed.FanCmd_Payload", "string", 0);
...
B tc_TempControlMixed_FanCmd_Payload__is(STACK_FRAME void* this);
tc_TempControlMixed_FanCmd_Payload tc_TempControlMixed_FanCmd_Payload__as(STACK_FRAME void *this);
...
void tc_TempControlMixed_FanCmd_Payload_apply(STACK_FRAME tc_TempControlMixed_FanCmd_Payload this, tc_TempControlMixed_FanCmd_Type value) {
  DeclNewStackFrame(caller, "FanCmd.scala", "tc.TempControlMixed.FanCmd_Payload", "apply", 0);
  this->value = value;
}