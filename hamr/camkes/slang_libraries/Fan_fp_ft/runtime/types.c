...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TNone_F8CCDD: return sizeof(struct None_F8CCDD); // None[tc.TempControlMixedSeL4CAmKES.Fan_Initialization_Api]
    case TNone_B1BC55: return sizeof(struct None_B1BC55); // None[tc.TempControlMixedSeL4CAmKES.Fan_Operational_Api]
    ...
    case TSome_4F31FE: return sizeof(struct Some_4F31FE); // Some[tc.TempControlMixedSeL4CAmKES.Fan_Initialization_Api]
    case TSome_568CC9: return sizeof(struct Some_568CC9); // Some[tc.TempControlMixedSeL4CAmKES.Fan_Operational_Api]
    ...
    case Ttc_TempControlMixedSeL4CAmKES_Fan_Initialization_Api: return sizeof(struct tc_TempControlMixedSeL4CAmKES_Fan_Initialization_Api); // tc.TempControlMixedSeL4CAmKES.Fan_Initialization_Api
    case Ttc_TempControlMixedSeL4CAmKES_Fan_Operational_Api: return sizeof(struct tc_TempControlMixedSeL4CAmKES_Fan_Operational_Api); // tc.TempControlMixedSeL4CAmKES.Fan_Operational_Api
    case Ttc_TempControlMixedSeL4CAmKES_Fan_fp_ft_Bridge: return sizeof(struct tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_Bridge); // tc.TempControlMixedSeL4CAmKES.Fan_fp_ft_Bridge
    case Ttc_TempControlMixedSeL4CAmKES_Fan_fp_ft_Bridge_EntryPoints: return sizeof(struct tc_TempControlMixedSeL4CAmKES_Fan_fp_ft_Bridge_EntryPoints); // tc.TempControlMixedSeL4CAmKES.Fan_fp_ft_Bridge.EntryPoints
