...
#define art_EventTriggered_portIds_(this) ((IS_D10119) &(this)->portIds)
...
inline B art_EventTriggered__inequiv(art_EventTriggered this, art_EventTriggered other) {
  return !art_EventTriggered__equiv(this, other);
};
